...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Tech Stack', description: 'JavaScript, React Js, NextJs,PHP, Laravel, ExpressJS, Postgres, Git/GitHub, TailWind, Bootstrap' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education/Certification', description: 'BS Industrial Engineer, Udemy Web Development BootCamp' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built more than 5 projects' }
];

export const toolsData = [
    assets.vscode, assets.postman, assets.git, assets.netlify, assets.vercel
];